...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '一阵风', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个认真做装修的人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sophia.aqufu.com', // 网站地址
